...
namespace Mininterior.RusicstMVC.Servicios.Controllers.Informes
{
    ...
    /// </summary>
    [Authorize]
    public class UsuariosGuardaronInformacionSistemaController : ApiController
    {
        /// <summary>
        ...
        [Route("api/Informes/UsuariosGuardaronInformacionSistema/{id}")]
        public IEnumerable<C_UsuariosGuardaronInformacionSistema_Result> Get(int id)
        {
            IEnumerable<C_UsuariosGuardaronInformacionSistema_Result> resultado = Enumerable.Empty<C_UsuariosGuardaronInformacionSistema_Result>(); ;
            try
            {
                using (EntitiesRusicst BD = new EntitiesRusicst())
                {
                    BD.Database.CommandTimeout = 3600;
                    resultado = BD.C_UsuariosGuardaronInformacionSistema(id).Cast<C_UsuariosGuardaronInformacionSistema_Result>().ToList(); ;
                }
