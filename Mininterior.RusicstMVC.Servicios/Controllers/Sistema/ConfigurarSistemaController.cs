...
// ***********************************************************************
// <copyright file="ConfigurarSistemaController.cs" company="Ministerio del Interior">
...
namespace Mininterior.RusicstMVC.Servicios.Controllers.Sistema
{
    ...
    /// <summary>
    /// Class ConfigurarSistemaController.
    /// </summary>
    [AllowAnonymous]
    public class ConfigurarSistemaController : ApiController
    {
        /// <summary>
        ...
        private string ImageAppString(string id)
        {
            using (EntitiesRusicst BD = new EntitiesRusicst())
            {
                ...
                C_ParametrosSistema_Result folder = BD.C_ParametrosSistema(SistemaGrupo.HeaderAppLogin, "HeaderApp.ImagesFolder").First();
        ...
        private string ImageHeaderString(string id)
        {
            ...
            {
                //Carpeta de donde se cargan las Imagenes
                C_ParametrosSistema_Result folder = BD.C_ParametrosSistema(SistemaGrupo.HeaderGobiernoLogin, "HeaderGobierno.ImagesFolder").First();
        ...
        private string ImageRSString(string id)
        {
            ...
            {
                //Carpeta de donde se cargan las Imagenes
                C_ParametrosSistema_Result folder = BD.C_ParametrosSistema(SistemaGrupo.SocialNetworksLogin, "SocialNetworks.ImagesFolder").First();
        ...
        private string ImageGobString(string id)
        {
            ...
            {
                //Carpeta de donde se cargan las Imagenes
                C_ParametrosSistema_Result folder = BD.C_ParametrosSistema(SistemaGrupo.CreditosGobiernoLogin, "CreditosGobierno.ImagesFolder").First();
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("api/Sistema/ConfiguracionSistema/")]
        public ConfigurarLoginModel Get()
        {
            ConfigurarLoginModel resultado = new ConfigurarLoginModel();
            ...
            try
            {
                ...
                {
                    //Imagenes Header
                    resultado.ImageApp = BD.C_ParametrosSistema(SistemaGrupo.HeaderAppLogin, "HeaderApp.Logo").First().ParametroValor;
                    resultado.ImageAppContent = ImageAppString(resultado.ImageApp);

                    resultado.ImageGob = BD.C_ParametrosSistema(SistemaGrupo.CreditosGobiernoLogin, "CreditosGobierno.LogoGobierno").First().ParametroValor;
                    resultado.ImageGobContent = ImageGobString(resultado.ImageGob);

                    resultado.ImageMint = BD.C_ParametrosSistema(SistemaGrupo.HeaderGobiernoLogin, "HeaderGobierno.LogoMin").First().ParametroValor;
                    resultado.ImageMintContent = ImageHeaderString(resultado.ImageMint);

                    resultado.ImagePais = BD.C_ParametrosSistema(SistemaGrupo.HeaderGobiernoLogin, "HeaderGobierno.LogoPais").First().ParametroValor;
                    resultado.ImagePaisContent = ImageHeaderString(resultado.ImagePais);

                    resultado.ImageVict = BD.C_ParametrosSistema(SistemaGrupo.HeaderGobiernoLogin, "HeaderGobierno.LogoVict").First().ParametroValor;
                    ...
                    //Texto Body
                    resultado.TextHome = BD.C_ParametrosSistema(SistemaGrupo.LoginBodyText, "Login.BodyText.HTMLCode").First().ParametroValor;

                    //Texto Footer
                    resultado.TextFooter = BD.C_ParametrosSistema(SistemaGrupo.FooterLogin, "Footer.HTMLCode").First().ParametroValor;

                    //Enlaces Gobierno
                    resultado.CantidadEnlaces = int.Parse(BD.C_ParametrosSistema(SistemaGrupo.CreditosGobiernoLogin, "CreditosGobierno.Links.Count").First().ParametroValor);
                    resultado.listLinks = FetchEnlacesGobierno(resultado.CantidadEnlaces, BD, 2);

                    //Slider
                    resultado.cantidadSlides = int.Parse(BD.C_ParametrosSistema(SistemaGrupo.BodySliderLogin, "BodySlider.ImageCount").First().ParametroValor);
                    resultado.listSlider = FetchSlider(resultado.cantidadSlides, BD, 2);
                }
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("api/Sistema/ConfiguracionSistema/ModificarRS")]
        public async Task<HttpResponseMessage> ModificarRS()
        {
            ...
            {
                (new AuditExecuted(Category.EditarSistemaRS)).ActionExecutedManual(model);
            }
        ...
        [HttpPost]
        [Route("api/Sistema/ConfiguracionSistema/ModificarMint")]
        public async Task<HttpResponseMessage> ModificarMint()
        {
            ...
            {
                (new AuditExecuted(Category.EditarSistemaMint)).ActionExecutedManual(model);
            }
        ...
        /// <returns>Task&lt;HttpResponseMessage&gt;.</returns>
        [HttpPost]
        [Route("api/Sistema/ConfiguracionSistema/ModificarApp")]
        public async Task<HttpResponseMessage> ModificarApp()
        {
            ...
            {
                (new AuditExecuted(Category.EditarSistemaApp)).ActionExecutedManual(model);
            }
        ...
        /// <returns>Task&lt;HttpResponseMessage&gt;.</returns>
        [HttpPost]
        [Route("api/Sistema/ConfiguracionSistema/ModificarGob")]
        public async Task<HttpResponseMessage> ModificarGob()
        {
            ...
            {
                (new AuditExecuted(Category.EditarSistemaGob)).ActionExecutedManual(model);
            }
        ...
        /// <returns>C_AccionesResultado.</returns>
        [HttpPost]
        [Route("api/Sistema/ConfiguracionSistema/ModificarSL")]
        public async Task<HttpResponseMessage> ModificarSL()
        {
            ...
            {
                (new AuditExecuted(Category.EditarSistemaSl)).ActionExecutedManual(model);
            }
        ...
        /// <returns>C_AccionesResultado.</returns>
        [HttpPost, AuditExecuted(Category.EditarSistemaTextoFooter)]
        [Route("api/Sistema/ConfiguracionSistema/GuardarTextoFooterBody")]
        ...
        /// <param name="model">The model.</param>
        /// <returns>C_AccionesResultado.</returns>
        [HttpPost, AuditExecuted(Category.EditarSistemaParametrosGobierno)]
        [Route("api/Sistema/ConfiguracionSistema/GuardarParametroGobierno")]
        ...
        [HttpGet]
        [AllowAnonymous]
        [Route ("api/Sistema/ConfiguracionSistema/test")]
        ...
        /// <param name="model">The model.</param>
        /// <returns>C_AccionesResultado.</returns>
        [HttpPost, AuditExecuted(Category.EliminarSistemaParametrosGobierno)]
        [Route("api/Sistema/ConfiguracionSistema/EliminarParametroGobierno")]
