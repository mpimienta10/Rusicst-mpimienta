...
// Created          : 03-20-2018
//
// Last Modified By : Equipo de desarrollo OIM - Andrés Bonilla
// Last Modified On : 03-20-2018
// ***********************************************************************
// <copyright file="SeguimientoPlanesMejoramientoController.cs" company="Ministerio del Interior">
...
namespace Mininterior.RusicstMVC.Servicios.Controllers.Sistema
{
    ...
    /// </summary>
    [Authorize]
    public class SeguimientoPlanesMejoramientoController : ApiController
    {
        #region Configuración Seguimiento Plan de Mejoramiento
        ...
        [HttpGet]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/ListadoSeguimientos")]
        public IEnumerable<C_ObtenerInformacionSeguimientosPlanMejoramiento_Result> GetSeguimientosPlan(int idPlan)
        {
            IEnumerable<C_ObtenerInformacionSeguimientosPlanMejoramiento_Result> resultado = Enumerable.Empty<C_ObtenerInformacionSeguimientosPlanMejoramiento_Result>();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerInformacionSeguimientosPlanMejoramiento(idPlan).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Inserta un nuevo Seguimiento a un plan de Mejoramiento.
        /// </summary>
        /// <param name="model">Entidad con los datos a insertar.</param>
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.CrearSeguimientoPlanMejoramiento)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/InsertarSeguimientoPlanMejoramiento")]
        public C_AccionesResultadoInsert InsertarSeguimientoPlan(PlanMejoramientoSeguimientoModel model)
        {
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.I_PlanMejoramientoSeguimientoInsert(model.idPlan, model.numeroSeguimiento, model.mensajeSeguimiento, model.fechaInicio, model.fechaFin, model.activo, model.idEncuesta).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Actualiza los datos de un Seguimiento Plan de Mejoramiento.
        /// </summary>
        /// <param name="model">Entidad con los datos a insertar.</param>
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.EditarSeguimientoPlanMejoramiento)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/ActualizarSeguimientoPlanMejoramiento")]
        public C_AccionesResultado ActualizarSeguimientoPlan(PlanMejoramientoSeguimientoModel model)
        {
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.U_PlanMejoramientoSeguimientoUpdate(model.idSeguimiento, model.numeroSeguimiento, model.mensajeSeguimiento, model.fechaInicio, model.fechaFin, model.activo, model.idEncuesta).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Elimina un seguimiento de un plan de mejoramiento, previa validacion.
        /// </summary>
        /// <param name="model">Entidad con los datos a eliminar.</param>
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.EliminarSeguimientoPlanMejoramiento)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/EliminarSeguimientoPlanMejoramiento")]
        public C_AccionesResultado EliminarSeguimientoPlan(PlanMejoramientoSeguimientoModel model)
        {
            C_AccionesResultado resultado = new C_AccionesResultado();
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.D_PlanMejoramientoSeguimientoDelete(model.idSeguimiento).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        #region Estados Acciones Seguimiento plan de mejoramiento

        /// <summary>
        /// Gets this instance.
        /// </summary>
        /// <returns>Lista con los datos de los estados de las acciones para el seguimiento</returns>
        [HttpGet]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/ListadoEstadosAcciones")]
        public IEnumerable<C_ObtenerInformacionEstadosAcciones_Result> GetEstadosAcciones()
        {
            IEnumerable<C_ObtenerInformacionEstadosAcciones_Result> resultado = Enumerable.Empty<C_ObtenerInformacionEstadosAcciones_Result>();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerInformacionEstadosAcciones().ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <param name="model">Entidad con los datos a insertar.</param>
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.CrearEstadoAccionSeguimientoPlan)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/EstadoAccion/InsertarEstadoAccion")]
        public C_AccionesResultadoInsert InsertarEstadoAccion(EstadosAccionesPlanModel model)
        {
            C_AccionesResultadoInsert resultado = new C_AccionesResultadoInsert();
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.I_PlanMejoramientoEstadoAccionInsert(model.estadoAccion, model.activo).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.EditarSeguimientoPlanMejoramiento)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/EstadoAccion/ActualizarEstadoAccion")]
        public C_AccionesResultado ActualizarEstadoAccion(EstadosAccionesPlanModel model)
        {
            C_AccionesResultado resultado = new C_AccionesResultado();
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.U_PlanMejoramientoEstadoAccionUpdate(model.idEstadoAccion, model.estadoAccion, model.activo).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Estado y respuesta.</returns>
        [HttpPost, AuditExecuted(Category.EliminarSeguimientoPlanMejoramiento)]
        [Route("api/Sistema/SeguimientoPlanMejoramiento/EstadoAccion/EliminarEstadoAccion")]
        public C_AccionesResultado EliminarEstadoAccion(EstadosAccionesPlanModel model)
        {
            C_AccionesResultado resultado = new C_AccionesResultado();
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.D_PlanMejoramientoEstadoAccionDelete(model.idEstadoAccion).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/DatosSeguimientoPlan")]
        public C_ObtenerInformacionSeguimientoPlanV3_Result GetDatosSeguimientosPlan(int idSeguimiento)
        {
            C_ObtenerInformacionSeguimientoPlanV3_Result resultado = new C_ObtenerInformacionSeguimientoPlanV3_Result();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerInformacionSeguimientoPlanV3(idSeguimiento).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ListadoSeccionesSeguimientoPlan")]
        public IEnumerable<C_ObtenerInformacionSeccionesSeguimientoPlanV3_Result> GetSeccionesSeguimientosPlan(int idPlan, int idUsuario)
        {
            IEnumerable<C_ObtenerInformacionSeccionesSeguimientoPlanV3_Result> resultado = Enumerable.Empty<C_ObtenerInformacionSeccionesSeguimientoPlanV3_Result>();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerInformacionSeccionesSeguimientoPlanV3(idPlan, idUsuario).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ListadoObjetivosSeguimientoPlan")]
        public IEnumerable<C_ObtenerDatosObjetivosSeguimientoPlanV3_Result> GetObjetivosSeguimientosPlan(int idSeccion, int idUsuario)
        {
            IEnumerable<C_ObtenerDatosObjetivosSeguimientoPlanV3_Result> resultado = Enumerable.Empty<C_ObtenerDatosObjetivosSeguimientoPlanV3_Result>();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerDatosObjetivosSeguimientoPlanV3(idSeccion, idUsuario).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ListadoAccionesSeguimientoPlan")]
        public IEnumerable<C_ObtenerDatosAccionesSeguimientoPlanV3_Result> GetAccionesSeguimientosPlan(int idObjetivo, int idUsuario, int idSeguimiento)
        {
            IEnumerable<C_ObtenerDatosAccionesSeguimientoPlanV3_Result> resultado = Enumerable.Empty<C_ObtenerDatosAccionesSeguimientoPlanV3_Result>();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerDatosAccionesSeguimientoPlanV3(idObjetivo, idUsuario, idSeguimiento).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ListadoEstadoAccionesSeguimiento")]
        public IEnumerable<C_ObtenerInformacionEstadosAcciones_Result> GetEstadosAccionesSeguimientosPlan()
        {
            IEnumerable<C_ObtenerInformacionEstadosAcciones_Result> resultado = Enumerable.Empty<C_ObtenerInformacionEstadosAcciones_Result>();
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerInformacionEstadosAcciones().Where(x => x.Activo).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ListadoAutoevaluacion")]
        ...
        /// <summary>
        /// Guarda las respuestas del seguimiento plan de mejoramiento.
        /// </summary>
        /// <returns>Task&lt;HttpResponseMessage&gt;.</returns>
        [HttpPost]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/GuardarSeguimientoPlan")]
        public C_AccionesResultado GuardarSeguimientoPlan(PlanMejoramientoV3Seguimiento model)
        {
            C_AccionesResultado Resultado = new C_AccionesResultado();
            C_AccionesResultado ResultadoTemp = new C_AccionesResultado();
            ...
            try
            {
                ...
                using (EntitiesRusicst BD = new EntitiesRusicst())
                {
                    for (int i = 0; i < cantidadTareas; i++)
                    {
                        ...
                        ResultadoTemp = BD.I_PlanMejoramientoSeguimientoAccionInsert(tarea.IdPlanSeguimiento, tarea.IdTarea, tarea.IdTareaPlan, tarea.IdUsuario, tarea.IdEstadoAccion, tarea.DescripcionEstado, tarea.IdAutoevaluacion, false).FirstOrDefault();

                        (new AuditExecuted(Category.CrearRespuestaSeguimientoPlan)).ActionExecutedManual(tarea);
                    }
                }
            ...
            {
                Resultado.estado = 0;
                Resultado.respuesta = "Ocurrió un error guardando la información del Seguimiento de Plan de Mejoramiento. Por favor intente nuevamente.";
        ...
        /// <summary>
        /// Guarda el archivo del seguimiento.
        /// </summary>
        /// <returns>Task&lt;HttpResponseMessage&gt;.</returns>
        [HttpPost]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/GuardarArchivoSeguimientoPlan")]
        public async Task<HttpResponseMessage> GuardarSeguimientoArchivoPlan()
        {
            C_AccionesResultado Resultado = new C_AccionesResultado();
            ...
            PlanMejoramientoSeguimientoFile model = (PlanMejoramientoSeguimientoFile)Helpers.Utilitarios.GetFormData<PlanMejoramientoSeguimientoFile>(result);
            ...
            try
            {
                using (EntitiesRusicst BD = new EntitiesRusicst())
                {
                    ...
                    Archivo.GuardarArchivoSeguimientoPlanMejoramientoV3Shared(archivo, sistema.UploadDirectory, OriginalFileName, model.userName, model.IdSeguimiento.ToString());

                    Resultado = BD.I_PlanMejoramientoSeguimientoArchivoInsert(model.IdSeguimiento, model.IdUsuario, OriginalFileName).FirstOrDefault();
                    //Resultado = BD.I_PlanMejoramientoFinalizacionPlanInsert(model.IdPlan, model.IdUsuario, OriginalFileName).FirstOrDefault();

                    AdjuntoArchivoSeguimientoPlanModel adjunto = new AdjuntoArchivoSeguimientoPlanModel() { IdSeguimiento = model.IdSeguimiento, Tipo = "Seguimiento", Valor = OriginalFileName, IdUsuario = model.IdUsuario, Username = model.userName };
            ...
            {
                Resultado.estado = 0;
                Resultado.respuesta = "Ocurrió un error guardando la información del Seguimiento del Plan de Mejoramiento";
        ...
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ValidarDiligenciamientoPlan")]
        public bool ValidarDiligenciamientoPlan(int idPlan, int idUsuario, int idSeguimiento)
        {
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ValidarPermisoGuardadoSeguimientoPlan(idUsuario, idPlan, idSeguimiento).FirstOrDefault().Value;
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Envio del seguimiento del de mejoramiento.
        /// </summary>
        /// <returns>Task&lt;HttpResponseMessage&gt;.</returns>
        [HttpPost, AuditExecuted(Category.EnviodeSeguimientoPlandeMejoramiento)]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/EnviarPlan")]
        public C_AccionesResultado EnviarPlan(PlanMejoramientoSeguimiento model)
        {
            C_AccionesResultado Resultado = new C_AccionesResultado();
            ...
            try
            {
                using (EntitiesRusicst BD = new EntitiesRusicst())
                {
                    ...
                    var validacion = BD.C_ValidarEnvioPlanV3(model.IdSeguimiento, model.IdUsuario, "SP").First();
                    ...
                    if (validacion != null)
                    {
                        ...
                        if (habilitado)
                        {
                            Resultado = BD.I_PlanMejoramientoEnvioPlanInsert(model.IdPlan, model.IdUsuario, "", "SP", model.IdSeguimiento).FirstOrDefault();
                            ...
                            if (Resultado.estado == (int)EstadoRespuesta.Insertado)
                            {
                                ...
                                var datosPlan = BD.C_ObtenerDatosSeguimientoPlanMejoramiento(model.IdSeguimiento).FirstOrDefault();

                                C_DatosSistema_Result datosSistema = BD.C_DatosSistema().First();
                                Helpers.Utilitarios.EnviarCorreoFinalizacionSeguimientoPlan(ref Resultado, new string[] { usuario.Email != null && !string.IsNullOrEmpty(usuario.Email) ? usuario.Email : (usuario.EmailAlternativo != null && !String.IsNullOrEmpty(usuario.EmailAlternativo)) ? usuario.EmailAlternativo : datosSistema.FromEmail }, datosPlan, usuario.UserName, datosSistema);

                                //// Valida si envió el correo, de lo contrario, elimina el usuario 
                                if (Resultado.estado == (int)EstadoRespuesta.Excepcion)
                                {
                                    Resultado.estado = 0;
                                    Resultado.respuesta = "Ocurrió un error finalizando el Seguimiento del Plan de Mejoramiento. Por favor intente de nuevo";
                                }
                                else
                                {
                                    //Confirmar si esto debe ir, es decir, si se guarda el envio de la encuesta al tiempo que el seguimiento plan de mejoramiento
                                    //BD.I_GuardarEnvioPlanMejoramientoEncuesta(model.IdPlan, model.IdUsuario);

                                    Resultado.estado = 1;
                                    Resultado.respuesta = "El Reporte RUSICST junto con el Seguimiento al Plan de Mejoramiento han sido enviados de manera exitosa. En los próximos minutos recibirá un mensaje de confirmación en el correo electrónico registrado en el Sistema.";
                                }
                            }
                        }
                        else
                        {
                            Resultado.estado = 0;
                            Resultado.respuesta = "El Seguimiento del Plan de Mejoramiento está incompleto y no se puede enviar. Por favor, verifique que exista al menos una Acción en cada Estrategia.";
                        }
                    }
                    else
                    {
                        Resultado.estado = 0;
                        Resultado.respuesta = "Ocurrió un error validando el envío del Seguimiento del Plan de Mejoramiento. Por favor intente de nuevo";
                    }
                }
            }
            catch (Exception ex)
            {
                Resultado.estado = 0;
                Resultado.respuesta = "Ocurrió un error enviando el Seguimiento del Plan de Mejoramiento. Por favor intente nuevamente.";
            }
            finally
            {
            }
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/SeguimientoPlanMejoramientoDownloadExcel/")]
        public HttpResponseMessage DescargarExcel(int idUsuario, int idPlan, int idSeguimiento)
        {
            try
            {
                ...
                var ws = workbook.Worksheets.Add("Seguimiento Plan Mejoramiento");
                ...
                List<C_ObtenerInformacionSeccionesSeguimientoPlanV3_Result> secciones = new List<C_ObtenerInformacionSeccionesSeguimientoPlanV3_Result>();
                C_Usuario_Result usuario = new C_Usuario_Result();

                using (var db = new EntitiesRusicst())
                {
                    secciones = db.C_ObtenerInformacionSeccionesSeguimientoPlanV3(idPlan, idUsuario).ToList();
                    usuario = db.C_Usuario(idUsuario, null, null, null, null, null, null).First();
                }

                var dataPlan = GetDatosSeguimientosPlan(idSeguimiento);

                #region Header Plan
                ws.Cell(2, 1).Style.Font.Bold = true;
                ws.Cell(2, 1).Style.Font.FontColor = XLColor.FromHtml("#63002D");
                ws.Cell(2, 1).Value = "Seguimiento Plan de Mejoramiento: " + dataPlan.Nombre;
                ...
                for (int i = 0; i < secciones.Count; i++)
                {
                    ...
                    if (string.IsNullOrEmpty(nomSeccion) || nomSeccion != seccion.Titulo)
                    {
                        ...
                        ws.Cell(fila, colm).Value = "Estado de la Acción";
                        ws.Column(colm).AdjustToContents();
                        ws.Range(fila, colm, fila + 1, colm).Merge();
                        ws.Cell(fila, colm).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                        ws.Cell(fila, colm).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
                        ...
                        ws.Cell(fila, colm).Value = "Descripción de Estado";
                        ws.Column(colm).AdjustToContents();
                        ws.Range(fila, colm, fila + 1, colm).Merge();
                        ws.Cell(fila, colm).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                        ws.Cell(fila, colm).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
                        ...
                        //ws.Cell(fila, colm).Value = "Coincide con el Rusicst";
                        //ws.Column(colm).AdjustToContents();
                        //ws.Range(fila, colm, fila + 1, colm).Merge();
                        //ws.Cell(fila, colm).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                        //ws.Cell(fila, colm).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
                    ...
                    //Inicio data seccion
                    List<C_ObtenerDatosObjetivosSeguimientoPlanV3_Result> dataSeccion = GetObjetivosSeguimientosPlan(seccion.IdSeccionPlanMejoramiento, idUsuario).ToList();

                    for (int j = 0; j < dataSeccion.Count; j++)
                    {
                        var estrategia = dataSeccion.ElementAt(j);

                        List<C_ObtenerDatosAccionesSeguimientoPlanV3_Result> dataTareas = GetAccionesSeguimientosPlan(estrategia.IdObjetivoGeneral, idUsuario, idSeguimiento).ToList();
                        ...
                        if(dataTareas.Count > 0)
                        {
                            //var tareaMatch = dataTareas.ElementAt(0);

                            //ws.Cell(fila, 9).Value = tareaMatch.CoincideRusicst.HasValue ? tareaMatch.CoincideRusicst.Value ? "Si" : "No" : "No";
                            //ws.Column(9).Width = 40;
                            //ws.Range(fila, 9, fila + cantFilasMerge, 9).Merge();
                            //ws.Cell(fila, 9).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                            //ws.Cell(fila, 9).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
                        }                        
                        ...
                        for (int k = 0; k < dataTareas.Count; k++)
                        {
                            ...
                            ws.Cell(fila, 3).Value = tarea.Accion;
                            ...
                            ws.Cell(fila, 6).Value = tarea.EstadoAccion;
                            ...
                            ws.Cell(fila, 7).Value = tarea.DescripcionEstado;
                            ws.Column(7).Width = 40;
                            ws.Cell(fila, 7).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Justify;
                            ws.Cell(fila, 7).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;

                            ws.Cell(fila, 8).Value = (tarea.IdAutoevaluacion - 1);
                            ws.Cell(fila, 8).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
                            ws.Cell(fila, 8).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center;
                ...
                var finalfilename = Path.Combine(@"c:\Temp", "Seguimiento_Plan_Mejoramiento");
                var filename = "Seguimiento_Plan_Mejoramiento.xlsx";
        ...
        /// Gets this instance.
        /// </summary>
        /// <returns>Validacion del Seguimiento del plan, para el usuario especifido</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/ArchivoSeguimientoPlan")]
        public string ArchivoSeguimientoPlan(int idSeguimiento, int idUsuario)
        {
            ...
            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerRutaSeguimientoPlan(idSeguimiento, idUsuario).FirstOrDefault().RutaArchivo;
                }
            }
            catch (Exception ex)
            {
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/PlanMejoramientoSeguimientoDownload/")]
        public HttpResponseMessage Descargar(string nombreArchivo, string usuario, string idSeguimiento)
        {
            try
            {
                string directorio = "";
                string dirSeguimiento = Archivo.pathPlanMejoraSeguimientoFiles;
                directorio = Path.Combine(dirSeguimiento, usuario, idSeguimiento);
        ...
        #region Validacion tipo plan e ids en indice encuesta
        ...
        /// <returns>Lista con los datos del Banco de Preguntas</returns>
        [HttpGet]
        [Route("api/Sistema/PlanesMejoramientoV3/Seguimiento/TipoPlanEIds")]
        public C_ObtenerIdTipoPlanEncuesta_Result GetDatosTipoPlan(int idEncuesta, int idUsuario)
        {
            C_ObtenerIdTipoPlanEncuesta_Result resultado = new C_ObtenerIdTipoPlanEncuesta_Result();

            try
            {
                using (EntitiesRusicst bd = new EntitiesRusicst())
                {
                    resultado = bd.C_ObtenerIdTipoPlanEncuesta(idEncuesta, idUsuario).FirstOrDefault();
                }
            }
            catch (Exception ex)
            {
