app.controller('ConfiguracionHomeController', ['$scope', '$http', 'APIService', 'UtilsService', '$log', '$uibModal', 'Upload', 'ngSettings', 'authService', function ($scope, $http, APIService, UtilsService, $log, $uibModal, Upload, ngSettings, authService) {
    $scope.started = true;
    $scope.datosHome = {};
    ...
    $scope.eliminarLinkGobierno = function (group, num) {
        ...
        $scope.url = '/api/Sistema/ConfiguracionHome/EliminarParametroGobierno';
    ...
    $scope.agregarLinkGobierno = function (group) {
        ...
        if (valido)
        {
            ...
            $scope.url = '/api/Sistema/ConfiguracionHome/GuardarParametroGobierno';
    ...
    $scope.modificarFooterHome = function (key, value, group) {
        ...
        $scope.url = '/api/Sistema/ConfiguracionHome/GuardarTextoFooterBody';
    ...
    $scope.uploadMint = function (file, key, value, group) {
        ...
        Upload.upload({
            url: $scope.serviceBase + '/api/Sistema/ConfiguracionHome/ModificarMint',
            method: "POST",
    ...
    $scope.uploadApp = function (file, key, value, group) {
        ...
        Upload.upload({
            url: $scope.serviceBase + '/api/Sistema/ConfiguracionHome/ModificarApp',
            method: "POST",
            data: $scope.imageMint,
            file: file,
        }).then(function (resp) {
    ...
    $scope.uploadGob = function (file, key, value, group) {
        ...
        Upload.upload({
            url: $scope.serviceBase + '/api/Sistema/ConfiguracionHome/ModificarGob',
            method: "POST",
            data: $scope.imageMint,
            file: file,
        }).then(function (resp) {
...
app.controller('ModalModificarRSController', ['$scope', 'APIService', '$filter', '$log', '$uibModalInstance', 'Upload', 'UtilsService', 'ngSettings', 'rs', 'authService', function ($scope, APIService, $filter, $log, $uibModalInstance, Upload, UtilsService, ngSettings, rs, authService) {
    ...
    $scope.upload = function (file) {
        ...
        Upload.upload({
            url: $scope.serviceBase + '/api/Sistema/ConfiguracionHome/ModificarRS',
            method: "POST",
            data: $scope.rs,
            file: file,
        }).then(function (resp) {
...
app.controller('ModalModificarSLController', ['$scope', 'APIService', '$filter', '$log', '$uibModalInstance', 'Upload', 'UtilsService', 'ngSettings', 'sl', 'authService', function ($scope, APIService, $filter, $log, $uibModalInstance, Upload, UtilsService, ngSettings, sl, authService) {
    ...
    $scope.upload = function (file) {
        ...
        Upload.upload({
            url: $scope.serviceBase + '/api/Sistema/ConfiguracionHome/ModificarSL',
            method: "POST",
            data: $scope.sl,
            file: file,
        }).then(function (resp) {
