app.controller('ListadoTableroSeguimientoDepartamentosController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', '$location', 'ngSettings', 'enviarDatos', 'authService', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal, $location, ngSettings, enviarDatos, authService) {
    ...
    $scope.MunicipioCompletados = function () {
        var url = '/api/TableroPat/ListaTablerosSeguimientoDepartamentoCompletados/' + $scope.userName;
    ...
    $scope.MunicipioPorCompletar = function () {
        var url = '/api/TableroPat/ListaTablerosSeguimientoDepartamentoPorCompletar/' + $scope.userName;
        var servCall = APIService.getSubs(url);
    ...
    $scope.Consultar = function (index) {
        ...
        $location.url('/Index/TableroPat/SeguimientoDepartamento');
    }
