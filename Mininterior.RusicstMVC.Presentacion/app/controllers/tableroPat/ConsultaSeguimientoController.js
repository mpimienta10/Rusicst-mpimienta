app.controller('ConsultaSeguimientoController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', '$location', 'authService','ngSettings', 'enviarDatos', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal, $location, authService, ngSettings, enviarDatos) {
    ...
    getDatos();
    function getDatos() {
        var url = '/api/TableroPat/DatosConsultaSeguimiento/?Usuario=' + $scope.userName;
