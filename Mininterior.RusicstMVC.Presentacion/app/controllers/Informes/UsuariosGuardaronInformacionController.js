app.controller('UsuariosGuardaronInformacionController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', 'authService', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal, authService) {
    ...
    var actionJson = {
        ...
        parameters: [
            ...
            { field: "GUARDO", newProperty: "Guardó" },
        ]
    };
    ...
    $scope.buscar = function () {
        ...
        if ($scope.EncuestaSeleccionada == 0) {
            ...
            var url = '/api/Informes/UsuariosGuardaronInformacionSistema/' + $scope.EncuestaSeleccionada;
            getDatos();
            function getDatos() {
