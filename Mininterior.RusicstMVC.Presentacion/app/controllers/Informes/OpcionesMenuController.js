app.controller('OpcionesMenuController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal) {
    ...
    function buscar() {
        $scope.alerta = null;
        var url = '/api/Informes/OpcionesMenu/';
        getDatos();
        function getDatos() {
