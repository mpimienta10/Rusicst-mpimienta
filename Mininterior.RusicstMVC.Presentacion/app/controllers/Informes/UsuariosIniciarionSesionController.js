app.controller('UsuariosIniciarionSesionController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', 'authService', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal, authService) {
    ...
    $scope.gridOptions = {
        ...
        exporterFieldCallback: function (grid, row, col, value) {
            if (col.colDef.displayName === 'Nombre de Usuario') value = UtilsService.exportPdfColumnLarge(col, value);
            if (col.colDef.displayName === 'Email') value = UtilsService.exportPdfColumnLarge(col, value);
            return value;
        },
    ...
    var actionJson = {
        ...
        parameters: [
            { field: "Cantidad", newProperty: "Cantidad de Inicios de Sesión" },
        ]
    };
    ...
    $scope.buscar = function () {
        ...
        if ($scope.EncuestaSeleccionada == 0) {
            ...
            var url = '/api/Informes/UsuariosIniciaronSesionSistema/' + $scope.EncuestaSeleccionada;
            getDatos();
            function getDatos() {
