app.controller('UsuariosGuardaronAutoevaluacionController', ['$scope', 'APIService', 'UtilsService', 'i18nService', '$http', 'uiGridConstants', '$interval', 'uiGridGroupingConstants', '$log', '$uibModal', 'authService', function ($scope, APIService, UtilsService, i18nService, $http, uiGridConstants, $interval, uiGridGroupingConstants, $log, $uibModal, authService) {
    ...
    $scope.buscar = function () {
        ...
        if ($scope.EncuestaSeleccionada == 0) {
            ...
            var url = '/api/Informes/UsariosGuardaronInformacionAutoevaluacion/' + $scope.EncuestaSeleccionada;
            getDatos();
            function getDatos() {
